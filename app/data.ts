...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    titleRu: "STOP: полная остановка",
    questionDe: "Welches Verhalten am Stoppschild ist richtig?",
    questionRu: "Как правильно действовать перед знаком STOP?",
    safeImage: "/scenarios/stop-sign-safe.webp",
    unsafeImage: "/scenarios/stop-sign-unsafe.webp",
    order: ["safe", "unsafe"],
    focus: "Stillstand · Sichtlinie · Vorfahrt",
    answerDe:
      "An der Haltlinie vollständig anhalten und Vorfahrt gewähren. Reicht die Sicht dort nicht, danach langsam bis zur Sichtlinie vortasten und erneut prüfen.",
    answerRu:
      "Полностью остановись у Haltlinie (стоп-линия; stop line) и уступи. Если обзора нет, после остановки медленно продвинься к Sichtlinie и проверь дорогу снова.",
    rule: "Anlage 2 StVO · Zeichen 206",
    severity: "kritisch",
  },
  {
    id: "lane-change-motorcycle",
    category: "Fahrstreifenwechsel",
    titleDe: "Motorrad im toten Winkel",
    titleRu: "Мотоцикл в слепой зоне",
    questionDe: "Wann darfst du den Fahrstreifen wechseln?",
    questionRu: "Когда можно безопасно перестроиться?",
    safeImage: "/scenarios/lane-change-motorcycle-safe.webp",
    unsafeImage: "/scenarios/lane-change-motorcycle-unsafe.webp",
    order: ["unsafe", "safe"],
    focus: "Spiegel · Blinker · Schulterblick",
    answerDe:
      "Innenspiegel, Außenspiegel, rechtzeitig blinken und Schulterblick. Erst wechseln, wenn das Motorrad sicher passiert ist und niemand gefährdet wird.",
    answerRu:
      "Внутреннее зеркало, наружное зеркало, поворотник, затем Schulterblick (проверка слепой зоны; shoulder check). Перестраивайся только после мотоцикла.",
    rule: "§ 7 Abs. 5 StVO · Fahrstreifenwechsel",
    severity: "kritisch",
  },
  {
    id: "cyclist-overtake",
    category: "Überholen",
    titleDe: "Radfahrer sicher überholen",
    titleRu: "Безопасный обгон велосипедиста",
    questionDe: "Darfst du den Radfahrer hier überholen?",
    questionRu: "Можно ли здесь обогнать велосипедиста?",
    safeImage: "/scenarios/cyclist-overtake-safe.webp",
    unsafeImage: "/scenarios/cyclist-overtake-unsafe.webp",
    order: ["safe", "unsafe"],
    focus: "Seitenabstand · Gegenverkehr · Geduld",
    answerDe:
      "Mit dem Kraftfahrzeug gelten mindestens 1,5 m Seitenabstand innerorts und 2 m außerorts. Reicht der Platz wegen Gegenverkehr nicht, hinter dem Radfahrer warten.",
    answerRu:
      "Минимум 1,5 м в городе и 2 м вне города. Если из-за встречной машины интервала нет, не обгоняй — жди позади велосипедиста.",
    rule: "§ 5 Abs. 4 StVO · Seitenabstand",
    severity: "kritisch",
  },
  {
    id: "green-light-pedestrians",
    category: "Abbiegen",
    titleDe: "Grün heißt nicht freie Fahrt",
    titleRu: "Зелёный не отменяет пешеходов",
    questionDe: "Wer hat beim Rechtsabbiegen Vorrang?",
    questionRu: "Кого нужно пропустить при повороте направо?",
    safeImage: "/scenarios/green-light-pedestrians-safe.webp",
    unsafeImage: "/scenarios/green-light-pedestrians-unsafe.webp",
    order: ["unsafe", "safe"],
    focus: "Fußgänger · Blickführung · Abbiegen",
    answerDe:
      "Beim Abbiegen auf zu Fuß Gehende besondere Rücksicht nehmen. Trotz Grün vor der Querung warten, bis alle die Fahrbahn sicher verlassen haben.",
    answerRu:
      "Даже при зелёном сигнале пропусти пешеходов на дороге, в которую поворачиваешь. Жди до полного освобождения траектории.",
    rule: "§ 9 Abs. 3 StVO · Abbiegen",
    severity: "kritisch",
  },
  {
    id: "priority-road-bend",
    category: "Vorfahrt",
    titleDe: "Abknickende Vorfahrtstraße",
    titleRu: "Главная дорога меняет направление",
    questionDe: "Welches Fahrzeug kündigt seine Richtung korrekt an?",
    questionRu: "Какая машина правильно показывает направление?",
    safeImage: "/scenarios/priority-road-bend-safe.webp",
    unsafeImage: "/scenarios/priority-road-bend-unsafe.webp",
    order: ["safe", "unsafe"],
    focus: "Zusatzzeichen · Blinker · Fußgänger",
    answerDe:
      "Wer dem Verlauf der abknickenden Vorfahrtstraße folgt, muss rechtzeitig und deutlich blinken. Auf Fußgänger besondere Rücksicht nehmen und nötigenfalls warten.",
    answerRu:
      "Если следуешь изгибу abknickende Vorfahrtstraße (bending priority road), заранее включи поворотник. Пешеходов не подвергай риску.",
    rule: "Anlage 3 StVO · Zeichen 306",
    severity: "wichtig",
  },
  {
    id: "shared-space-child",
    category: "Wohngebiet",
    titleDe: "Verkehrsberuhigter Bereich",
    titleRu: "Жилая зона и ребёнок",
    questionDe: "Welche Geschwindigkeit ist hier richtig?",
    questionRu: "С какой скоростью нужно двигаться здесь?",
    safeImage: "/scenarios/shared-space-child-safe.webp",
    unsafeImage: "/scenarios/shared-space-child-unsafe.webp",
    order: ["unsafe", "safe"],
    focus: "Schrittgeschwindigkeit · Bremsbereitschaft",
    answerDe:
      "Nur Schrittgeschwindigkeit fahren. Fußgänger dürfen die ganze Straßenbreite nutzen, Kinderspiele sind erlaubt. Niemanden gefährden oder behindern; wenn nötig warten.",
    answerRu:
      "Только Schrittgeschwindigkeit (скорость шага; walking speed). Дети могут играть по всей ширине. Будь готов остановиться и при необходимости жди.",
    rule: "Anlage 3 StVO · Zeichen 325.1",
    severity: "kritisch",
  },
  {
    id: "zipper-merge",
    ...
    titleRu: "Перестроение «молнией»",
    questionDe: "Wo und wie wird richtig eingefädelt?",
    questionRu: "Где и как правильно перестраиваться?",
    safeImage: "/scenarios/zipper-merge-safe.webp",
    unsafeImage: "/scenarios/zipper-merge-unsafe.webp",
    order: ["safe", "unsafe"],
    focus: "Verengung · Abstand · Kooperation",
    answerDe:
      "Den endenden Fahrstreifen bis unmittelbar vor die Verengung nutzen. Dort abwechselnd je ein Fahrzeug einordnen lassen — ohne Drängeln oder paralleles Erzwingen.",
    answerRu:
      "Доедь почти до сужения и там перестраивайся по одному через одного: Reißverschlussverfahren (zipper merge). Не вклинивайся бок о бок.",
    rule: "§ 7 Abs. 4 StVO · Reißverschluss",
    severity: "wichtig",
  },
  {
    id: "blind-rural-curve",
    category: "Landstraße",
    titleDe: "Unübersichtliche Kurve",
    titleRu: "Слепой поворот",
    questionDe: "Welche Linie und Geschwindigkeit sind sicher?",
    questionRu: "Какие траектория и скорость безопасны?",
    safeImage: "/scenarios/blind-rural-curve-safe.webp",
    unsafeImage: "/scenarios/blind-rural-curve-unsafe.webp",
    order: ["unsafe", "safe"],
    focus: "Sichtweite · Rechtsfahrgebot · Tempo",
    answerDe:
      "So langsam fahren, dass innerhalb der übersehbaren Strecke angehalten werden kann. Rechts bleiben und niemals die Fahrbahnmitte in der blinden Kurve schneiden.",
    answerRu:
      "Скорость должна позволять остановиться в видимой зоне. Держись справа и не срезай слепой поворот через середину дороги.",
    rule: "§§ 2, 3 StVO · Sichtfahrgebot",
    severity: "kritisch",
  },
  {
    id: "emergency-vehicle",
    category: "Sonderrechte",
    titleDe: "Blaulicht und Einsatzhorn",
    titleRu: "Спецтранспорт с сиреной",
    questionDe: "Wie schaffst du sofort freie Bahn?",
    questionRu: "Как немедленно освободить путь?",
    safeImage: "/scenarios/emergency-vehicle-safe.webp",
    unsafeImage: "/scenarios/emergency-vehicle-unsafe.webp",
    order: ["safe", "unsafe"],
    focus: "Ruhe · Blinker · Freie Bahn",
    answerDe:
      "Bei Blaulicht zusammen mit Einsatzhorn sofort freie Bahn schaffen. Umgebung prüfen, klar blinken, kontrolliert weit rechts fahren und nötigenfalls sicher anhalten.",
    answerRu:
      "При синем маячке вместе с сиреной немедленно освободи путь. Проверь окружение, покажи намерение поворотником, плавно уйди вправо и при необходимости остановись.",
    rule: "§ 38 Abs. 1 StVO · Blaulicht",
    severity: "kritisch",
  },
  {
    id: "reverse-pedestrian",
    category: "Rückwärtsfahren",
    titleDe: "Rückwärts ausparken",
    titleRu: "Выезд задним ходом",
    questionDe: "Welches Verhalten schützt den Fußgänger?",
    questionRu: "Какой вариант защищает пешехода?",
    safeImage: "/scenarios/reverse-pedestrian-safe.webp",
    unsafeImage: "/scenarios/reverse-pedestrian-unsafe.webp",
    order: ["unsafe", "safe"],
    focus: "Rundumsicht · Langsamkeit · Stopp",
    answerDe:
      "Beim Rückwärtsfahren muss jede Gefährdung ausgeschlossen sein. Rundum beobachten, sehr langsam rollen und sofort stoppen; bei fehlender Sicht einweisen lassen.",
    answerRu:
      "При движении назад нельзя создавать опасность. Осматривай всё вокруг, двигайся очень медленно и сразу остановись; при плохом обзоре попроси Einweiser (guide).",
    rule: "§ 9 Abs. 5 StVO · Rückwärtsfahren",
    severity: "kritisch",
  },
  {
    id: "left-turn-oncoming",
    category: "Abbiegen",
    titleDe: "Linksabbiegen mit Gegenverkehr",
    titleRu: "Левый поворот и встречная машина",
    questionDe: "Wer darf zuerst fahren?",
    questionRu: "Кто должен проехать первым?",
    safeImage: "/scenarios/left-turn-oncoming-safe.webp",
    unsafeImage: "/scenarios/left-turn-oncoming-unsafe.webp",
    order: ["safe", "unsafe"],
    focus: "Gegenverkehr · Blinker · Lücke",
    answerDe:
      "Wer links abbiegt, muss entgegenkommende Fahrzeuge durchfahren lassen. Früh blinken, korrekt einordnen und erst bei sicherer Lücke abbiegen.",
    answerRu:
      "При левом повороте пропусти встречный транспорт, который едет прямо. Поворачивай только в безопасное окно.",
    rule: "§ 9 Abs. 3 StVO · Linksabbiegen",
    severity: "kritisch",
  },
  {
    id: "tram-stop-passengers",
    category: "Straßenbahn",
    titleDe: "Fahrgäste an der Haltestelle",
    titleRu: "Пассажиры у трамвая",
    questionDe: "Wie passierst du die haltende Straßenbahn?",
    questionRu: "Как проехать мимо остановившегося трамвая?",
    safeImage: "/scenarios/tram-stop-passengers-safe.webp",
    unsafeImage: "/scenarios/tram-stop-passengers-unsafe.webp",
    order: ["unsafe", "safe"],
    focus: "Schrittgeschwindigkeit · Abstand · Warten",
    answerDe:
      "Beim Ein- oder Aussteigen rechts nur mit Schrittgeschwindigkeit und so viel Abstand vorbeifahren, dass niemand gefährdet oder behindert wird. Wenn nötig warten.",
    answerRu:
      "Пока пассажиры входят или выходят, справа можно ехать только со Schrittgeschwindigkeit и большим интервалом. Если безопасного прохода нет — стой.",
    rule: "§ 20 Abs. 2 StVO · Straßenbahn",
    severity: "kritisch",
  },
];
