...
- локальный onboarding: имя, дата экзамена, этап и слабые темы;
...
- увеличенная типографика и контрастный вторичный текст.
...
трекеры. Необязательное имя, дата экзамена, выбранный фокус и прогресс остаются
в `localStorage`. API-ключи и runtime-secrets не требуются. Подробности:
